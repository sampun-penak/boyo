...
if (command == 'creator') {
  ...
  const sentMsg = await conn.sendContactArray(m.chat, [
    [`${nomorown}`, `${await conn.getName(nomorown+'@s.whatsapp.net')}`, `👑 Developer Bot `, `🚫 Don't call me 🥺`, `nb.boruto.official@gmail.com`, `🇮🇩 Indonesia`, `🚀 Lu Wibu? `, `👤 Udah punya ayank 😔`],
